...
const Contactme = () => {
  const handleButtonClick = () => {
    const phoneNumber = "9820248153";
    window.location.href = `tel:${phoneNumber}`;
  };
  const emaillink = () => {
    window.location.href = "sahum3378@gmail.com";
  };
  return (
      ...
      <div className="heading-div">
        <button className="heading-textbtn">
          <h1 className="mainheading">
            Contact <span style={{ color: "#0e4166" }}>Me</span>
          </h1>
        </button>
      </div>
          ...
          <div className="details-cards">
            <div className="details-card red" onClick={handleButtonClick}>
              <div>
                ...
                <p id="contact-phone">+91 9820248153</p>
              </div>
            </div>
        ...
        <div className="contact-form-div">
          <div className="contact-card">
            ...
            <form
              ...
              action="https://formsubmit.co/sahum3378@gmail.com"
              method="POST"
            >
